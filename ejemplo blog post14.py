...
economia = BbnNode(Variable(1, 'economia', ['P', 'N']), [0.6, 0.4])
...
trabajo = BbnNode(Variable(3, 'trabajo', ['S', 'N']), [0.3, 0.7,
                                                       0.1, 0.9,
                                                       0.8, 0.2,
                                                       0.4, 0.6])

vivienda = BbnNode(Variable(4, 'vivienda', ['P', 'N']), [0.7, 0.3,
                                                         0.4, 0.6])


dificultad = BbnNode(Variable(5, 'dificultad', ['S', 'N']), [0.01, 0.99,
                                                             0.05, 0.95,
                                                             0.4, 0.6, 
                                                             0.8, 0.2])
paga = BbnNode(Variable(6, 'paga', ['S', 'N']), [0.6, 0.4,
                                                 0.98, 0.02,
                                                 0.1, 0.9,
                                                 0.95, 0.05])
